...
| --- | --- |
| Ben Goodey | Practical AI SEO infrastructure, bottom-funnel SaaS content, and avoiding shallow AI-generated content. |
| Ryan Law | Detailed AI writing workflows, AI search research, and content operations from a mature SaaS SEO team. |
| Kevin Indig | Data-backed AI search analysis, trust signals, and how visibility shifts as AI Overviews and AI answers grow. |
| Bernard Huang | GEO/AEO workflow design, AI visibility measurement, and content optimization from a tooling perspective. |
| Eli Schwartz | Product-led SEO judgment: when to create content, when not to, and how to avoid chasing low-quality search demand. |
| Ross Simmonds | Distribution, third-party validation, and how content gets discovered beyond the company blog. |
| Andy Crestodina | Conversion-focused content strategy, practical AI use cases, and protecting human proof points. |
| Amanda Natividad | Zero-click content, audience research, and realistic adoption of AI search across different buyer groups. |
...
That angle is more differentiated because it combines:

- Content operations
- AI workflow design
- AI search visibility
- B2B SaaS buying intent
- Distribution and third-party proof
- Revenue measurement
